...
const LocationView = (props) => {
    ...
    return <div className="lg:w-1/3 mx-auto pt-12">
        ...
        <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl">
            Let's think about moving. <br></br> What county do you want to compare to?
        </p>
            ...
            <AutocompleteInput suggestions={suggestions} onSelect={
                (newLocation) => {
                    ...
                    newState.secondaryCounty = newLocation.county;
                    newState.secondaryState = newLocation.state;
